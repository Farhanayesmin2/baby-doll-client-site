  ...
  <div class="relative block h-32 lg:col-span-2 lg:h-full">
    ...
    />
                ...
                <div class="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
                    <div className='text-[#56d3c4] text-2xl font-serif font-bold'>
        ...
        <ul class="mt-8 space-y-1 text-md  font-semibold text-gray-500">
          <li><span className='font-bold text-lg text-[#56d3c4]'> Present Address:</span>  Dhaka,Bangladesh.</li>
          <li><span className='font-bold text-lg text-[#56d3c4]'> Permanent Address:</span> Canada, torento.</li>
        </ul>

        <ul class="flex gap-6 mt-8 text-[#ddbbdc]">
          <li>
            <a
              href="/"
              rel="noreferrer"
            ...
            >
              ...
              <svg
                class="w-6 h-6 text-[#c09da9] hover:text-[#56d3c4]"
                fill="currentColor"
                viewBox="0 0 24 24"
                aria-hidden="true"
              >
    ...
    <div class="pt-12 mt-12 border-t border-gray-100">
      <div class="sm:flex sm:items-center sm:justify-between">
        ...
        <p class="mt-8 text-xs text-gray-500 sm:mt-0">
          &copy; 2023. Farhana Yesmin. All rights reserved.
        </p>
      </div>
    </div>
  </div>
