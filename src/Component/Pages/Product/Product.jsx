  ...
  <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
    <header>
      <h2 class="text-xl font-bold text-gray-900 sm:text-3xl">
       Our top valuable product collection
      </h2>

      <p class="mt-4 max-w-md text-gray-500">
       "Doll Collection Heaven is your ultimate destination for a journey into the magical world of doll collecting. As a leading specialist in this unique sector, we offer an extraordinary assortment of dolls that appeal to collectors of all ages and tastes.
      </p>
    </header>
        ...
        <ul class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <li>
            <a href="#" class="group block overflow-hidden">
              <img
                src="https://i.ibb.co/DbQLX7G/bb3e91b835e9247422c1829ea69b6153.jpg"
                alt=""
          ...
          <li>
            <a href="#" class="group block overflow-hidden">
              <img
                src="https://i.ibb.co/5F4dnmJ/dbb99b30de30ea3f42de031b9f68f7db.jpg"
                alt=""
                class="h-[350px] w-full object-cover transition duration-500 group-hover:scale-105 sm:h-[450px]"
              />
          ...
          <li>
            <a href="#" class="group block overflow-hidden">
              <img
                src="https://i.ibb.co/XtW0ByB/e1ffc5e7bfdc39fb8cb3f5a110ce5f46.jpg"
                alt=""
                class="h-[350px] w-full object-cover transition duration-500 group-hover:scale-105 sm:h-[450px]"
              />
