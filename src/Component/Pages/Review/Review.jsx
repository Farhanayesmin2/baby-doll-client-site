...
const Review = () => {
  return (
    <div className=" container mx-auto my-10   ">
          <h2 className="text-3xl text-pink-400 font-bold text-center my-3">Customer reviews</h2>
          
          <div className='grid sm:grid-cols-1 lg:grid-cols-2 gap-4  '>
              
    
     <div className="  border-2 border-pink-300 flex flex-col max-w-xl p-8 shadow-sm rounded-xl lg:p-12 dark:bg-gray-900 dark:text-gray-100">
	<div className="flex flex-col items-center w-full">
		...
		<div className="flex flex-col w-full">
			...
			<button type="button" className="py-4 my-8 font-semibold rounded-md dark:text-gray-900 dark:bg-green-400">Leave feedback</button>
		</div>
	</div>
   ...
   <div className="grid-cols-1 border-2 border-pink-300 flex flex-col max-w-xl p-8 shadow-sm rounded-xl lg:p-12">
	<div className="flex flex-col w-full">
        ...
        <p class="mt-2 text-gray-700">
         "I purchased this doll for my daughter's 6th birthday, and she absolutely adores it. The craftsmanship is superb and the details are so realistic. It's become her favorite toy."
        </p>
		</div>
	</div>
</div> 
